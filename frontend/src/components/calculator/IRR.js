...
// // import ToolFooter from './ToolFooter'; // Ensure this file is named ToolFooter.js and uses PascalCase
// import Tool_Footer from './Tools_footer';
// import '@fortawesome/fontawesome-free/css/all.min.css';
// // import CalculatorList from './CalculatorsList'; // Ensure this file is named CalculatorsList.js and uses PascalCase
...
//         total + cashFlow / Math.pow(1 + rate, index), 0
//       );
//     };

//     const npvDerivative = (rate) => {
//       return cashFlows.reduce((total, cashFlow, index) => 
//         total - index * cashFlow / Math.pow(1 + rate, index + 1), 0
//       );
//     };

//     for (let i = 0; i < maxIterations; i++) {
//       const currentNpv = npv(irr);
//       if (Math.abs(currentNpv) < precision) break;
//       irr -= currentNpv / npvDerivative(irr);
//     }

//     return irr;
//   };

//   const calculateIRRResult = useCallback(() => {
//     if (!validateForm()) return; 
  
//     const adjustedCashFlows = [-initialInvestment, ...cashFlows];
//     const calculatedIRR = calculateIRR(adjustedCashFlows);
  
//     if (!isNaN(calculatedIRR)) {
//       setIrrResult((calculatedIRR * 100).toFixed(2));
...
//       setIrrResult('N/A');
//     }
//   }, [initialInvestment, cashFlows, validateForm]);
