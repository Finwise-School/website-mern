                        ...
                        {result && (
                            <div className="space-y-2">
                                <div className="grid grid-cols-1 gap-2" style={{ "row-gap": "0.6rem" }}>
                                    ...
                                    <div className="p-4 border border-gray-300 rounded-lg">
                                        <p className="text-gray-600 flex items-center">FIRE <FontAwesomeIcon icon={faInfoCircle} className="text-gray-400 ml-2" /></p>
                                        <p className="text-blue-600 font-semibold text-xl">&#163;{result.fire}</p>
                                    </div>
                                    <div className="p-4 border border-gray-300 rounded-lg">
                                        <p className="text-gray-600 flex items-center">FAT FIRE <FontAwesomeIcon icon={faInfoCircle} className="text-gray-400 ml-2" /></p>
                                        <p className="text-blue-600 font-semibold text-xl">&#163;{result.fatFIRE}</p>
                                    </div>
                                </div>
                            </div>
                        )}
