  ...
  const tools = [
    {
      ...
      imageSrc: "frontend/src/components/Homepage/Tools/fire.png"
    },
    {
      title: "Goal SIP Tool",
      description: "Plan and implement your financial goals with our Goal SIP tool",
      imageSrc: "frontend/src/components/Homepage/Tools/goal_sip.png"
    },
    {
      title: "More Financial Tools",
      description: "Use over 10+ calculators and tools that help you with every financial decision.",
      imageSrc: "frontend/src/components/Homepage/Tools/calc_tools.png"
    }
  ];

  return (
    <section className="flex flex-col self-center mt-32 w-full max-w-[1596px] max-md:mt-10 max-md:max-w-full">
