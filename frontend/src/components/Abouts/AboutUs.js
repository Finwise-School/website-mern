    ...
    <div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg">
              ...
              began as a passionate group with a vision, dedicated to building an
      ...
      <div className="bg-black text-white py-16">
        <div className="container mx-auto px-8">
          <div className="pb-12">
            <h1 className="text-4xl font-bold mb-4">Navigating the Finwise School Experience</h1>
            <p>
              Navigating the Finwise School process is simple and designed to
              guide you toward financial success. Here's a step-by-step overview:
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border-1 border-blue-500 p-5 relative">
              ...
              <div className="absolute top-0 left-0 h-full w-2 bg-blue-500 shadow-md"></div>
            </div>

            <div className="border-l border-blue-500 p-5 relative">
      ...
      <div>
        <div className=" text-center justify-center p-20">
          ...
          <p>At Finwise School, our success is fueled by the support and expertise of our valued partners.</p>
        </div>

        <div className=" flex justify-center">
          <div className=" border-2 p-5 border-black justify-center mr-10">
            <img src={inspire} height={200} width={200}/>
          </div>

          <div className=" border-2 p-5 border-black justify-center mr-10">
            <img src={barclays} height={200} width={200}/>
          </div>

          <div className=" border-2 p-5 border-black justify-center mr-10">
            <img src={univ} height={200} width={200}/>
          </div>
      ...
      <div className=" justify-center text-center p-20"> 
        ...
        <p>Our Partner Portal offers customized financial planning solutions tailored specifically for corporate clients. Collaborate with Finwise School to provide your employees with seamless access to exclusive tools and expert advice, empowering them to achieve their financial goals.</p>
        <div className=" flex p-20">
           <img className="image1 pr-9" src={left} height={500} width={500} alt="left"/>
           <img className="image1" src={right} height={200} width={400} alt="right"/>
        </div>
      </div>
      ...
      <div>
        <div>
        <h1 className=" text-3xl pb-5 justify-center text-center">Start Your Financial Journey Today</h1>
          <p>Your path to financial freedom is just a click away. Whether you’re aiming to optimize your investments, create a solid savings plan, or receive expert financial advice, FinWise is here to guide you every step of the way. Take the first step towards achieving your financial goals—explore our innovative planning tools or connect with our team for personalized support tailored to your needs.</p>
        </div>
      </div>
