    ...
    <div className="bg-white w-full h-3/6 px-6 lg:px-20 py-12 lg:py-16">
      <div className="max-w-screen-lg mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="mt-6 lg:mt-0 lg:ml-10">
          <a
            href="#"
            className="inline-block border-2 border-[#263871] text-[#263871] hover:border-green-500 hover:text-green-500 rounded-lg py-3 px-6 lg:px-8 text-base lg:text-lg min-w-[200px] lg:min-w-[250px] text-center transition-all duration-300"
          >
