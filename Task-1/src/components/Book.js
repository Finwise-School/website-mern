...
const Book = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-4 md:px-8 flex flex-col md:flex-row items-center md:items-start">
      <div className="w-full md:w-1/2 mb-8 md:mb-0">
        <img src="../img/call-img.avif" alt="Support Illustration" className="w-full h-auto" />
      </div>
